...
<html>
    <head>
        ...
        <style>
            ...
            .bg-image {
                /* The image used */
                background-image: url("resources/hospital3.jpg");
    ...
    <body>
        ...
        <div class="bg-text">
            <table id="t01">
                <tr>
                    <th colspan="2"style="text-align: center">Trillium Health Partners - Mississauga Hospital</th>
                </tr>
            ...
            <table id="t01">
                ...
                <tr>
                    <td> 100 Queensway W, Mississauga, ON L5B 1B8</td>
                </tr>
            </table>
