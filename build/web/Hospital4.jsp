...
<html>
    <head>
        ...
        <style>
            ...
            .bg-image {
                /* The image used */
                background-image: url("resources/hospital4.jpg");
    ...
    <body>
        ...
        <div class="bg-text">
            <table id="t01">
                <tr>
                    <th colspan="2"style="text-align: center">Milton District Hospital</th>
                </tr>
            ...
            <table id="t01">
                ...
                <tr>
                    <td>725 Bronte St S, Milton, ON L9T 9K1</td>
                </tr>
            </table>
            ...
            <table id="t01">
                ...
                <tr>
                    <td>Pediatric Specialty Care</td>
                </tr>
                <tr>
